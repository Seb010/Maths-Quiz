...
def showLeaderboard():
    ...
    if currentuseranswers != 0:
        ...
        usersOnLeaderboardTmp[0].setPoints(10) # set score for robot
        ...
        leaderboardCloseButton = tk.Button(leaderboardFrame, text="Back to Main Menu", highlightcolor="red", command=showWelcomePage)
        leaderboardCloseButton.pack()
...
def playQuadraticFormula():
    ...
    userName = currentUserNameEntry.get()
...
def about():
    tk.messagebox.showinfo(title="About", message="Last Release Date: 6th March 2025\n"
